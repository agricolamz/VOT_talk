...
- **POA**: labial; dental; lateral; velar; uvular
...
- **type of utterance**: first, second and third repetitions; carrier phrase
...
---
# Lists of words
- **a**: only existing words (non-words were at first used in Mehweb and then discarded)
- **b**: three repetitions followed by a carrier phrase
- **c**: when possible, two or more lexical items recorded for each sound and in each position
- **d**: keep the wordlist manageable (several dozens up to 100 words, 20-40 minutes recording session)
- **e**: aCa > VCa > VCi, VCe (but not in Andi)
- **f**: stress position not controlled 
- **g**: eliciting words by a Russian translation, sometimes the target word hinted in a half voice or, ideally, distorted
...
: Garik and Vasilisa check and correct eventual mistakes in annotation
...
- princinples of normalization of duration measurements

--

- different contexts
--
: lists of words were compiled using different principles (no voiced in Mehweb, very few speakers in Archi, no control for vowel quality in Andi etc.).
...
- speaker inconsistency: some speak casually and some dictate
--
- different sound recordings conditions
--
: headset microphone vs. hand-held recorders; different recorders;
...
some 1500 tokens annotated and processed
